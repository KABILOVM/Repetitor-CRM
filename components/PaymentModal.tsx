...
export const PaymentModal: React.FC<PaymentModalProps> = ({ 
  ...
  // Яркий зеленый для оплаты и насыщенный красный для возврата
  const confirmBtnColor = isRefund ? '#e11d48' : '#10b981';

  return (
    <div className="fixed inset-0 bg-black/60 z-[350] flex items-center justify-center p-4 backdrop-blur-sm animate-in fade-in duration-200">
                ...
                {!targetStudent ? (
                    ...
                    <div className="space-y-6 animate-in fade-in duration-300">
                        ...
                        <div className="space-y-2">
                            <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-widest ml-1">Сумма {isRefund ? 'возврата' : 'оплаты'}</label>
                            <div className="relative group">
                        ...
                        {/* Payment Methods */}
                        <div className="space-y-2">
                            <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-widest ml-1">Способ {isRefund ? 'выплаты' : 'оплаты'}</label>
                        ...
                        {method === 'Другое' && (
                            <div className="space-y-2 animate-in slide-in-from-top-2 duration-200">
                                <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-widest ml-1">Укажите способ оплаты / Банк</label>
                        ...
                        {isRefund && (
                            <div className="space-y-2 animate-in fade-in slide-in-from-top-2 duration-300">
                                <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-widest ml-1">Причина возврата</label>
                                <textarea 
                                    value={refundReason} 
