                                ...
                                <div className="pt-2">
                                    ...
                                    <div className="space-y-4 mb-3">
                                        {editingStudent.subjects && editingStudent.subjects.length > 0 ? editingStudent.subjects.map(subject => {
                                            ...
                                            return (
                                                <div key={subject} className="flex items-center justify-between gap-4 p-3.5 bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded-xl shadow-sm hover:border-blue-400 transition-colors relative z-10">
                                                    ...
                                                    {!isTeacher && (
                                                        <button 
                                                            ...
                                                            className="text-rose-400 hover:text-red-600 p-2.5 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-xl transition-all active:scale-95 flex-shrink-0 relative z-[50] border-2 border-transparent hover:border-red-100"
                                                            title="Убрать курс"
                                                        >
