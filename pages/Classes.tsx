...
export const Classes: React.FC = () => {
    ...
    // Fix: Cast array to allow checking against UserRole | string
    const isStaff = ([UserRole.GeneralDirector, UserRole.Director, UserRole.Admin, UserRole.Teacher, UserRole.Developer] as (UserRole | string)[]).includes(user.role);
                ...
                <div className="flex gap-1.5 mb-4 shrink-0 overflow-x-auto hide-scrollbar">
                    {[
                        ...
                        <button 
                            ...
                            className={`flex items-center gap-2 px-5 py-2 rounded-xl text-[10px] font-bold uppercase tracking-widest transition-