...
export const Students: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-6rem)] antialiased font-sans">
      ...
      <div className="flex-1 min-h-0 bg-white dark:bg-slate-800 rounded-[24px] shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden flex flex-col">
        <div className="shrink-0 p-5 border-b border-slate-200 dark:border-slate-700 flex flex-col xl:flex-row gap-4 justify-between items-start xl:items-end bg-slate-50/30 dark:bg-slate-800/50">
          ...
          <div className="relative w-full xl:w-72">
            ...
            <input
              ...
              className="w-full h-[42px] pl-11 pr-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 focus:outline-none focus:ring-4 focus:ring-blue-500/5 focus:border-blue-500 text-sm bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-100 placeholder-slate-400 transition-all shadow-sm font-bold tracking-tight"
            />
          </div>
        </div>
        ...
        <div className="flex-1 overflow-auto custom-scrollbar relative">
          <table className="w-full text-left border-collapse">
            <thead className="sticky top-0 z-20">
              <tr className="bg-slate-50 dark:bg-slate-900 text-slate-500 dark:text-slate-400 text-[10px] font-bold uppercase tracking-widest border-b border-slate-100 dark:border-slate-700">
                <th className="p-4 pl-8 cursor-pointer hover:text-blue-600 transition-colors" onClick={() => toggleSort('fullName')}>
                ...
                return (
                    ...
                    <td className="p-4 pl-8">
                        <div className="flex items-center gap-4">
                            ...
                            <span className="font-bold text-slate-800 dark:text-slate-100 text-base tracking-tight">{student.fullName}</span>
                        </div>
                    </td>
